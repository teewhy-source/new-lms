  ...
  return (
    <div className='flex flex-col w-[100%] md:w-[15rem] items-center bg-[#5bbcb3] bg-opacity-30 shadow-lg shadow-green-700'>
      ...
      <div className='mt-[2rem] flex flex-col gap-[2rem] font-semibold cursor-pointer mr-[3rem] text-[#14408b]'>
        <Link to="/Display/profile" className={`${location.pathname === "/Display/profile" && " p-10"} flex flex-row items-center justify-around gap-[0.2rem] hover:bg-gradient-to-r from-[white] via-[grey] to-[yellow] p-[0.4rem] hover:translate-x-5 hover:rounded-2xl hover:transition-all`}> <CgProfile /> Profile</Link>
