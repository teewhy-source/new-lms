    ...
    <div className='flex flex-col items-center bg-[#5bbcb3] bg-opacity-30 shadow-lg shadow-green-700'>
      <div className="text-white text-xl font-bold mb-4 md:mb-0 flex w-[10rem]">
        ...
        <div className='mt-[2rem] flex flex-col gap-[2rem] font-semibold cursor-pointer mr-[3rem] text-[#14408b]'>
          ...
          <Link to="/Display/profile" className={`${location.pathname === "/Display/profile" && "bg-[#14408b] p-10"}flex flex-row items-center justify-around gap-[0.2rem] hover:bg-gradient-to-r from-[white] via-[grey] to-[yellow] p-[0.4rem] hover:translate-x-5 hover:rounded-2xl hover:transition-all`}> <CgProfile/>Profile</Link>
          <Link to="/Display/CourseUpload" className='flex flex-row items-center justify-around gap-[0.2rem] hover:bg-gradient-to-r from-[white] via-[grey] to-[yellow] p-[0.4rem] hover:translate-x-5 hover:rounded-2xl hover:transition-all'> <BiBookAdd/>Add Course</Link>
          ...
          <Link to="/Display/PageNotFound" className='flex flex-row items-center justify-around gap-[0.2rem] hover:bg-gradient-to-r from-[white] via-[grey] to-[yellow] p-[0.4rem] hover:translate-x-5 hover:rounded-2xl hover:transition-all'> <FaAward/> Awards</Link>
          <Link to="/Display/PageNotFound" className='flex flex-row items-center justify-around gap-[0.2rem] hover:bg-gradient-to-r from-[white] via-[grey] to-[yellow] p-[0.4rem] hover:translate-x-5 hover:rounded-2xl hover:transition-all'> <MdQuiz/> Quizzes</Link>
